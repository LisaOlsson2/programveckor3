...
public class Player : MonoBehaviour
{
    ...
    [SerializeField]
    private GameObject frame1L;

    [SerializeField]
    private GameObject frame2L;

    [SerializeField]
    private GameObject frame3L;

    [SerializeField]
    private GameObject frame4L;

    [SerializeField]
    private GameObject frame5L;

    [SerializeField]
    private GameObject frame6L;

    [SerializeField]
    private GameObject frame1R;

    [SerializeField]
    private GameObject frame2R;

    [SerializeField]
    private GameObject frame3R;

    [SerializeField]
    private GameObject frame4R;

    [SerializeField]
    private GameObject frame5R;

    [SerializeField]
    private GameObject frame6R;

    [SerializeField]
    KeyCode animationTest;
